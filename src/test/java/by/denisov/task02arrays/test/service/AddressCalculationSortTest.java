...
public class AddressCalculationSortTest {
    @DataProvider(name = "addressCalculationSortDataProvider")
    public Object[][] addressCalculationSortDataProvider(){
        return new Object[][] {
    ...
    @Test(description = "Address calculation sort test", dataProvider = "addressCalculationSortDataProvider")
    public void addressCalculationSortTest(Double[] array1, Double[] array2){
